...
- (void)setImageNameArray:(NSArray *)imageNameArray
{
  ...
  [_imageNameArray enumerateObjectsUsingBlock:^(AdModel *obj, NSUInteger idx, BOOL *stop) {
      [self.dataArray addObject:obj.img];
  }];
   
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:self.dataArray[0]] placeholderImage:[UIImage imageNamed:DefaultImage]];
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:self.dataArray[1]] placeholderImage:[UIImage imageNamed:DefaultImage]];
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:self.dataArray[2]] placeholderImage:[UIImage imageNamed:DefaultImage]];
...
//    
//    
//    _leftAdLabel.hidden = YES;
//    _centerAdLabel.hidden = YES;
//    _rightAdLabel.hidden = YES;
//    
//    
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
  ...
  [_leftImageView sd_setImageWithURL:[NSURL URLWithString:self.dataArray[(currentImage-1)%_imageNameArray.count]] placeholderImage:[UIImage imageNamed:DefaultImage]];
//    _leftAdLabel.text = _adTitleArray[(currentImage-1)%_imageNameArray.count];
    
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:self.dataArray[(currentImage)%_imageNameArray.count]] placeholderImage:[UIImage imageNamed:DefaultImage]];
//    _centerAdLabel.text = _adTitleArray[currentImage%_imageNameArray.count];
    
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:self.dataArray[(currentImage+1)%_imageNameArray.count]] placeholderImage:[UIImage imageNamed:DefaultImage]];
