...
@interface OrdershareController  ()<UITableViewDelegate,UITableViewDataSource,PullingRefreshTableViewDelegate,OrdershareViewCellDelegate,UIScrollViewDelegate>
{
    UIImageView*img;
...
@implementation OrdershareController
...
- (void)noData
{
    if (!self.nodataView)
    {
        ...
        _nodataView.titleLabel.text=@"还没有晒单记录";
        _nodataView.textLabel.text=@"";
        [_nodataView.btgoto setTitle:@"马上夺宝" forState:UIControlStateNormal];
