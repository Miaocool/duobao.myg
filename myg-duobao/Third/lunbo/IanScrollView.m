...
- (void)_initScrollView
{
    ...
    for (NSInteger i = 0; i < _slideImagesArray.count; i++) {
       ...
       // slideImage.contentMode = UIViewContentModeScaleAspectFit; //裁剪
        [slideImage sd_setImageWithURL:[NSURL URLWithString:_slideImagesArray[i]] placeholderImage:[UIImage imageNamed:DefaultImage]];
//        slideImage.contentMode = UIViewContentModeScaleAspectFill;
        slideImage.clipsToBounds = YES;
        slideImage.tag = i;
...
//    firstSlideImage.contentMode = UIViewContentModeScaleAspectFill;
    ...
    [firstSlideImage sd_setImageWithURL:[NSURL URLWithString:_slideImagesArray[_slideImagesArray.count - 1]] placeholderImage:[UIImage imageNamed:DefaultImage]];
...
//    endSlideImage.contentMode = UIViewContentModeScaleAspectFill;
    ...
    [endSlideImage sd_setImageWithURL:[NSURL URLWithString:_slideImagesArray[0]] placeholderImage:[UIImage imageNamed:DefaultImage]];
